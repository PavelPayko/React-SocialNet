...
const UsersPage = (props) => {
        ...
        let subscriptionsList = props.subscriptionsList.map(user => (
        ...
        let pagination = props.pageList.map(page => {
                ...
                return (<span className={(props.currentPage === page) ? `${classes.paginationItem} ${classes.active}` : classes.paginationItem}
